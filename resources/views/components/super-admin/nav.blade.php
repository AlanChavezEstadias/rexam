<div x-data="{ sidebarOpen: true, userMenuOpen: false }" class="flex h-screen bg-gray-100">
    ...
    <nav :class="sidebarOpen ? 'w-64' : 'w-20'"
        ...
        <div class="flex items-center justify-between p-4 border-b border-white/30">
            <span x-show="sidebarOpen" class="text-lg font-bold">SUPERADMIN</span>
        ...
        <ul class="flex-1 p-4 space-y-2">
            ...
            <li>
                <a href="{{ route('super-admin.dashboard') }}"
                    class="flex items-center gap-3 p-2 rounded hover:bg-black/30 {{ request()->routeIs('super-admin.dashboard') ? 'text-sonora-naranja font-semibold' : 'text-white hover:text-sonora-naranja' }}">
                    <x-heroicon-o-home
                        class="w-5 h-5 {{ request()->routeIs('super-admin.dashboard') ? 'text-sonora-naranja' : 'text-white group-hover:text-sonora-naranja' }}" />
            ...
            <li>
                <a href="{{ route('super-admin.users.index') }}"
                    class="flex items-center gap-3 p-2 rounded hover:bg-black/30 {{ request()->routeIs('super-admin.users.*') ? 'text-sonora-naranja font-semibold' : 'text-white hover:text-sonora-naranja' }}">
                    <x-heroicon-o-users
                        class="w-5 h-5 {{ request()->routeIs('super-admin.users.*') ? 'text-sonora-naranja' : 'text-white group-hover:text-sonora-naranja' }}" />
